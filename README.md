...
Stack
Frontend — React, Vite. Deployed on Vercel. Backend — Node.js, Express 5, Anthropic SDK (Claude), SQLite via better-sqlite3, JWT auth, express-rate-limit, pdf-parse. Document generation — Python (python-pptx, python-docx, openpyxl) called from the Node backend.
